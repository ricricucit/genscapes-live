...
function fftArray(time) {

  if( freqArray == undefined) var freqArray = new Array(numFreqs);
...
function updateAnalysers(time) {
    if (!analyserContext) {
        var canvas = document.getElementById("audioAnalyserMonitor");
    ...
    // analyzer draw code here
    {
        ...
        for (var i = 0; i < numBars; ++i) {
            ...
            analyserContext.fillRect(i * BAR_WIDTH + SPACING, canvasHeight, BAR_WIDTH, -(magnitude/256*canvasHeight));
        }
    }
